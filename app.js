...
(function () {
  ...
  const i18n = {
    bs: {
      ...
      "gallery.title": "Atmosfera Zayna", "reviews.eyebrow": "Recenzije", "reviews.title": "Riječi naših gostiju",
    ...
    en: {
      ...
      "gallery.title": "Zayn's Atmosphere", "reviews.eyebrow": "Reviews", "reviews.title": "What our guests say",
    ...
    fr: {
      ...
      "gallery.title": "Atmosphère Zayn", "reviews.eyebrow": "Avis", "reviews.title": "Ce que disent nos clients",
    ...
    it: {
      ...
      "gallery.title": "Atmosfera Zayn", "reviews.eyebrow": "Recensioni", "reviews.title": "Cosa dicono i nostri ospiti",
    ...
    de: {
      ...
      "gallery.title": "Zayn Atmosphäre", "reviews.eyebrow": "Bewertungen", "reviews.title": "Was unsere Gäste sagen",
    ...
    ar: {
      ...
      "gallery.title": "أجواء زين", "reviews.eyebrow": "التقييمات", "reviews.title": "آراء ضيوفنا",
    ...
    tr: {
      ...
      "gallery.title": "Zayn Atmosferi", "reviews.eyebrow": "Yorumlar", "reviews.title": "Misafirlerimiz ne diyor",
    ...
    ja: {
      ...
      "gallery.title": "ザインの雰囲気", "reviews.eyebrow": "レビュー", "reviews.title": "お客様の声",
    ...
    zh: {
      ...
      "gallery.title": "Zayn 的氛围", "reviews.eyebrow": "评价", "reviews.title": "客人怎么说",
    ...
    ko: {
      ...
      "gallery.title": "Zayn의 분위기", "reviews.eyebrow": "후기", "reviews.title": "손님들의 이야기",
  ...
  function applyLang(lang) {
    ...
    document.querySelectorAll(".split-words[data-i18n]").forEach(function (el) {
      el.dataset.split = "";
      el.classList.remove("is-in");
    });
    document.querySelectorAll(".reveal.visible .split-words, .hero .split-words").forEach(function (el) {
      splitWords(el);
    });
  }
  ...
  function initReveal() {
    ...
    var observer = new IntersectionObserver(function (entries) {
      entries.forEach(function (entry) {
        ...
        entry.target.querySelectorAll(".split-words").forEach(function (el) {
          splitWords(el);
        });
        if (entry.target.classList.contains("split-words")) splitWords(entry.target);
  ...
  function initSpaMenu() {
    document.querySelectorAll(".spa-item-toggle").forEach(function (btn) {
      btn.addEventListener("click", function () {
        var item = btn.closest(".spa-item");
        if (!item) return;
        var open = item.classList.contains("is-open");
        document.querySelectorAll(".spa-item.is-open").forEach(function (other) {
          if (other === item) return;
          other.classList.remove("is-open");
          var ob = other.querySelector(".spa-item-toggle");
  ...
  function initReviewsCarousel() {
    ...
    var curEl = document.getElementById("reviewsCur");
    ...
    function show(i) {
      ...
      if (curEl) curEl.textContent = pad2(index + 1);
    }
  ...
  function animateStats(scope) {
    var nodes = (scope || document).querySelectorAll(".stat-num");
  ...
  function splitWords(el) {
    ...
    parts.forEach(function (part) {
      ...
      span.style.transitionDelay = (delay * 0.05) + "s";
      el.appendChild(span);
      delay += 1;
    });
  ...
  function refreshSplitWords() {
    document.querySelectorAll(".split-words").forEach(function (el) {
      el.dataset.split = "";
      el.classList.remove("is-in");
      // leave text as applyLang set it; re-split if visible
      if (el.closest(".reveal.visible") || el.closest(".hero") || el.classList.contains("visible")) {
        splitWords(el);
      }
    });
  }
  ...
  function initPageLoader() {
    ...
    if (document.readyState === "complete") {
      ...
      window.addEventListener("load", function () { setTimeout(done, 700); });
    }
  }
  ...
  function initCustomCursor() {
    ...
    document.querySelectorAll("a, button, .spa-item-toggle, .ba-handle, select").forEach(function (el) {
  ...
  function initBurger() {
    ...
    function toggleNav() { setOpen(!nav.classList.contains("open")); }
  ...
  function initHeroMotes() {
    ...
    for (var i = 0; i < 12; i++) {
      ...
      mote.style.animationDuration = 10 + Math.random() * 16 + "s";
  ...
  function initHeroSlideshow() {
    ...
    var urls = [
      "assets/salon-home.jpeg",
      "assets/salon-home1.jpeg",
      "assets/salon-home2.jpeg",
      "assets/salon-home3.jpeg",
      "assets/salon-home4.jpeg"
    ];
    ...
    document.addEventListener("visibilitychange", function () {
      ...
      else if (hero.classList.contains("is-ready") && !reduced) start();
    });

    preload(urls).then(function () {
      // sync with page loader: wait a beat after load for black → photo
      var boot = function () {
  ...
  function initBeforeAfter() {
    ...
    function setPosition(pct) {
      ...
      // Desno = Poslije potpuno prekriva Prije
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    initPageLoader();
    initCustomCursor();
    document.querySelectorAll(".hero .split-words").forEach(function (el) {
      setTimeout(function () { splitWords(el); }, 900);
    });
  });
})();
